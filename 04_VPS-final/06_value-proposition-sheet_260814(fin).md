...
> **통합 원본:** 챕터 04-08 전체(01-03은 별도 사업인 핀테크 마이데이터/토큰증권 실습이므로 통합하지 않는다 — §0 참조)
> **작성 대상:** 미술품 토큰증권을 기획하다가 가치가 충분히 발견되지 못한 작품의 순환 문제를 발견한 예비 창업팀
> **작성 목적:** 비즈니스 리서치(TAM-SAM-SOM, 페르소나 스펙트럼, CJM, AOS-DOS, JTBD, 경쟁 지형·가치 선언)를 이 문서 안에 직접 포함(rooting)하여, *왜 이 시장인지, 누구에게, 어떤 본질적 가치를, 어떤 차별성으로 제공하는지*를 정의하고 MVP 개발 계획까지 **단일 문서로 관리**한다.
...
| # | 섹션 | 내용 요약 |
|---|------|----------|
| 0 | [이 문서의 범위](#0-이-문서의-범위--두-개의-서로-다른-구조가-이-저장소에-공존한다) | 우리 저장소가 두 개의 서로 다른 사업 실습을 담고 있다는 것 |
...
| 구조 | 성격 | 이 문서와의 관계 |
|---|---|---|
| **`01-`-`09-` 번호 챕터** | 산업 리서치부터 시작하는 공식 커리큘럼 순서. 09-value-proposition에서 끝나며 10번은 존재하지 않는다 | 이 문서의 **원본 데이터** — 아래 Ⅱ-Ⅳ가 발췌·요약해 담는다 |
| **`00_`-`04_` 언더스코어 폴더** | 챕터 번호가 아니라 작업 단계(Prompt 이력→분석→VPS 초안→PRD 초안→VPS 최종)로 구성한 **별도 실습 트랙** | **이 문서가 속한 곳** — `04_VPS-final` 단계 |

그중 번호 챕터 내에서도 우리 저장소는 **두 개의 독립된 실습 사업**을 담고 있다.

| 챕터 | 사업 | 이 문서와의 관계 |
|---|---|---|
| [01-porters-five-forces](https://github.com/ahalenin12-art/business_research/tree/main/01-porters-five-forces/) · [02-value-chain](https://github.com/ahalenin12-art/business_research/tree/main/02-value-chain/) · [03-ksf](https://github.com/ahalenin12-art/business_research/tree/main/03-ksf/) | 핀테크 마이데이터 vs 토큰증권 (별도 실습) | **통합하지 않음** — 다른 사업 |
| [04-tam-sam-som](https://github.com/ahalenin12-art/business_research/tree/main/04-tam-sam-som/) · [05-persona-journey](https://github.com/ahalenin12-art/business_research/tree/main/05-persona-journey/) · [06-opportunity-score](https://github.com/ahalenin12-art/business_research/tree/main/06-opportunity-score/) · [07-jtbd](https://github.com/ahalenin12-art/business_research/tree/main/07-jtbd/) · [08-competitor-branding](https://github.com/ahalenin12-art/business_research/tree/main/08-competitor-branding/) · [09-value-proposition](https://github.com/ahalenin12-art/business_research/tree/main/09-value-proposition/) | 예술품 재분배 × 미술품 토큰증권 가치순환 플랫폼 | **이 문서의 원본** |

이 사업은 미술품 토큰증권을 기획하다가 **가치가 충분히 발견되지 못한·미활용·보관한계 작품을 어떻게 순환시킬 것인가**라는 문제를 발견하면서 시작됐다([챕터 04 사후 기록](https://github.com/ahalenin12-art/business_research/blob/main/04-tam-sam-som/분석-03-예술품-재분배-플랫폼.md#-사후-기록--이-사업의-출발점은-미술품-토큰증권-기획이다)). 아래 Ⅱ-Ⅳ는 챕터 04-08의 산출물을 요약·발췌해 이 문서 안에 직접 담되(rooting), 세부 산출 근거는 각 챕터 원본에 남겨 이중 관리를 피한다.

> 📌 **`01_Biz-Analysis`와 이 문서의 관계.** [01_Biz-Analysis](../01_Biz-Analysis/)는 이 사업에 대한 Porter's·경쟁사·가치사슬·KSF·TAM-SAM-SOM·페르소나·CJM·AOS-DOS·JTBD 10종을 이 자리의 형식에 맞춰 갖춘 폴더다. 이 중 Porter's([1_porters-forces.md](../01_Biz-Analysis/1_porters-forces.md))·가치사슬([3_value-chain.md](../01_Biz-Analysis/3_value-chain.md))·KSF([4_ksf-report.md](../01_Biz-Analysis/4_ksf-report.md))는 이 사업에 대한 별도 분석이 원래 없었기 때문에, 챕터 04-08의 기존 데이터(경쟁 지형·Gate 모델·JTBD·AOS-DOS)를 근거로 역산해 새로 작성했다 — 원본 리서치처럼 실제 인터뷰·1차 자료를 새로 수집한 것은 아니라는 점을 숨기지 않는다.
...
> **출처:** [챕터 04 분석-방법론](https://github.com/ahalenin12-art/business_research/blob/main/04-tam-sam-som/분석-방법론.md), [분석-03](https://github.com/ahalenin12-art/business_research/blob/main/04-tam-sam-som/분석-03-예술품-재분배-플랫폼.md)
...
> ⚠️ **TAM과 SAM은 같은 측정 대상이 아니다.** TAM은 하향식(미국 전체 기부금 총량), SAM은 상향식(참여 의향 기관 합산)으로 별도 산정했다 — Giving USA가 목적별 비중을 공개하지 않아 하향식 필터링이 불가능했기 때문이다. 이 사실을 숨기지 않는다([챕터 04 수치검증 메모](https://github.com/ahalenin12-art/business_research/blob/main/04-tam-sam-som/분석-03-예술품-재분배-플랫폼.md#수치-검증-메모) 참조).

#### 1-2. 경쟁 지형 — 8개 서비스, 3개의 빈 자리

> **출처:** [챕터 08 경쟁 지형과 가치 선언](https://github.com/ahalenin12-art/business_research/blob/main/08-competitor-branding/경쟁사-가치선언-3-예술품-재분배-플랫폼.md)
...
> **출처:** [챕터 05 페르소나 스펙트럼](https://github.com/ahalenin12-art/business_research/blob/main/05-persona-journey/분석-03-예술품-재분배-플랫폼-페르소나-스펙트럼-.md), [챕터 06 대표 페인포인트](https://github.com/ahalenin12-art/business_research/blob/main/06-opportunity-score/평가대상-03-대표-페인포인트.md)
...
> 🔍 **JTBD 예행연습이 13번째 표본을 새로 발견했다.** [재분배 참여를 포기한 독립 작가(R8)](https://github.com/ahalenin12-art/business_research/blob/main/07-jtbd/모의결과보고서-03-예술품-재분배-플랫폼.md#1-8-재분배-참여를-포기한-독립-작가r8-신규-모집--가설-없음) — 12명 어디에도 없던 인물. *"'재분배 우선 작품'이 제 작품 등급표처럼 느껴졌어요"*. 공급자의 진짜 장벽은 "폐기"가 아니라 **"가치 없는 작품으로 분류되는 낙인"**일 수 있다는 발견은 §Ⅳ·§Ⅴ에서 핵심 Outcome(O15)으로 다룬다.

### 📉 3. 문제의 깊이 — 12명이 공유하는 세 개의 관문

> **출처:** [챕터 06 성격별 분류](https://github.com/ahalenin12-art/business_research/blob/main/06-opportunity-score/평가대상-03-대표-페인포인트.md#7-성격별-분류--36개를-가로지르는-다섯-갈래) (36개 Pain을 5갈래로 분류)
...
> **출처:** [챕터 06 AOS 분석](https://github.com/ahalenin12-art/business_research/blob/main/06-opportunity-score/분석-03-예술품-재분배-플랫폼.md) · [DOS 분석](https://github.com/ahalenin12-art/business_research/blob/main/06-opportunity-score/분석-03-예술품-재분배-플랫폼-DOS.md) · [혼합매트릭스](https://github.com/ahalenin12-art/business_research/blob/main/06-opportunity-score/분석-03-예술품-재분배-플랫폼-혼합매트릭스.md)
...
> **출처:** [챕터 07 JTBD 모의 결과보고서](https://github.com/ahalenin12-art/business_research/blob/main/07-jtbd/모의결과보고서-03-예술품-재분배-플랫폼.md) — 8명 모의 인터뷰(R1-R8), 실제 인터뷰 아님(가정 위의 가정)
...
| 수익원 | 성격 | 근거 | 지금의 위치 |
|---|---|---|---|
| ① Funding 조성·집행 수수료 | 가장 먼저 검증 가능 | 예술나무·크라우드펀딩 플랫폼이 조건부 기부·기업 파트너십을 이미 운영([챕터 08](https://github.com/ahalenin12-art/business_research/blob/main/08-competitor-branding/경쟁사-가치선언-3-예술품-재분배-플랫폼.md#2-5-한국문화예술위원회-예술나무--문화예술-기부-자체는-이미-인프라가-있다))한다는 선례는 있으나, **정확한 수수료율은 우리 리서치에 없다** | (가정) — MVP 파일럿에서 실측 필요 |
| ② 후속 상업활용 환류 수수료 | 방향 A의 실행 수단 | 오픈갤러리의 소유자측 렌탈·재판매 수익 선례([챕터 08 §2-2](https://github.com/ahalenin12-art/business_research/blob/main/08-competitor-branding/경쟁사-가치선언-3-예술품-재분배-플랫폼.md#2-2-오픈갤러리--작품의-두-번째-쓰임을-상업적으로-회전시킨다))는 있으나 **작가 수익의 직접 근거는 아님** | (가정) — 후속 지불자 자체가 미검증(§Ⅴ 차별가치 참조) |
...
> **근거:** [챕터 09 공식본 §7-1 다섯 경로 수렴](https://github.com/ahalenin12-art/business_research/blob/main/09-value-proposition/value-proposition-03-art-redistribution-platform-v1.0.md#7-1-다섯-경로가-같은-결론으로-수렴한다), O05 DOS(SAM) 4.00(전체 1위)
...
> **근거:** [JTBD §1-8](https://github.com/ahalenin12-art/business_research/blob/main/07-jtbd/모의결과보고서-03-예술품-재분배-플랫폼.md#1-8-재분배-참여를-포기한-독립-작가r8-신규-모집--가설-없음), O15 DOS(SAM) 1.80 🆕
...
- **Secondary 타겟(확장 Gate):** 미술관 박소연·기관자산 서재원(권리 Gate) + 기업 CSR 최은영(실사 패키지)
  > ✅ **교차 검증됨.** [02_VPS-Drafts의 Opus 5 vs Sonnet 5 독립 비교](../02_VPS-Drafts/04_analysis_vps_comparison.md#3-초기-공급-파트너--가장-생산적인-불일치)에서, 챕터 04(Segment)의 "대형 미술관 우선" 권고와 챕터 06(SOM)의 실제 우선순위 이동이 서로 어긋난다는 것이 드러났다 — SOM 기준으로는 개인 초기 작가가 최우선으로 올라오고 기관 공급은 니치로 내려간다. 이 문서가 신진 작가를 Primary, 미술관을 Secondary로 둔 것은 이 SOM 근거와 일치한다
...
- **대응:** 미술은행의 기존 대여계약·상태확인서 서식([챕터 08 §2-1](https://github.com/ahalenin12-art/business_research/blob/main/08-competitor-branding/경쟁사-가치선언-3-예술품-재분배-플랫폼.md#2-1-국립현대미술관-미술은행나눔미술은행--공공예산으로-작품을-순환시킨다))을 참고해 법무 검토를 거친 표준 동의서를 MVP 착수 전 확정한다.

#### 🔴 F3 리스크: '낙인 없는 프레이밍'이 표본 1(R8)의 과잉해석일 수 있음

- **현실 상황:** JTBD는 모의 응답(가정 위의 가정)이며, R8 표본은 1명이다.
- **대응:** 참여 포기 작가 표본을 8명 이상으로 확대 인터뷰([JTBD §6](https://github.com/ahalenin12-art/business_research/blob/main/07-jtbd/모의결과보고서-03-예술품-재분배-플랫폼.md#6-다음-단계) 순위 4)한 뒤 UX 언어를 확정한다. 그 전까지는 가설 딱지를 유지한다.
...
| # | 검증 항목 | 방법 | 소요 |
|---|---|---|---|
| V1 | 실제 인터뷰 실행 (8개 페르소나) | 기존 [문항지](https://github.com/ahalenin12-art/business_research/blob/main/07-jtbd/인터뷰-문항지-03-예술품-재분배-플랫폼.md) 재사용 | 2-3주 |
...
| # | 파일 | 유형 | 주요 기여 섹션 |
|---|---|---|---|
| 1 | [챕터 04 분석-방법론](https://github.com/ahalenin12-art/business_research/blob/main/04-tam-sam-som/분석-방법론.md) · [분석-03](https://github.com/ahalenin12-art/business_research/blob/main/04-tam-sam-som/분석-03-예술품-재분배-플랫폼.md) | TAM-SAM-SOM, Market Segment | Ⅱ-1.1 |
| 2 | [챕터 05 페르소나 스펙트럼](https://github.com/ahalenin12-art/business_research/blob/main/05-persona-journey/분석-03-예술품-재분배-플랫폼-페르소나-스펙트럼-.md) · [고객여정지도](https://github.com/ahalenin12-art/business_research/blob/main/05-persona-journey/분석-03-예술품-재분배-플랫폼-고객여정지도.md) | 페르소나·CJM | Ⅱ-2, Ⅱ-3 |
| 3 | [챕터 06 평가대상](https://github.com/ahalenin12-art/business_research/blob/main/06-opportunity-score/평가대상-03-대표-페인포인트.md) · [AOS](https://github.com/ahalenin12-art/business_research/blob/main/06-opportunity-score/분석-03-예술품-재분배-플랫폼.md) · [DOS](https://github.com/ahalenin12-art/business_research/blob/main/06-opportunity-score/분석-03-예술품-재분배-플랫폼-DOS.md) · [혼합매트릭스](https://github.com/ahalenin12-art/business_research/blob/main/06-opportunity-score/분석-03-예술품-재분배-플랫폼-혼합매트릭스.md) | AOS-DOS 통합 분석 | Ⅲ 전체 |
| 4 | [챕터 07 JTBD 모의결과보고서](https://github.com/ahalenin12-art/business_research/blob/main/07-jtbd/모의결과보고서-03-예술품-재분배-플랫폼.md) | JTBD 인터뷰 | Ⅳ 전체, Ⅴ Proof |
| 5 | [챕터 08 경쟁 지형과 가치 선언](https://github.com/ahalenin12-art/business_research/blob/main/08-competitor-branding/경쟁사-가치선언-3-예술품-재분배-플랫폼.md) · [차별적 가치목표 제안](https://github.com/ahalenin12-art/business_research/blob/main/08-competitor-branding/가치목표-제안-3-예술품-재분배-플랫폼.md) | 경쟁 분석, Value Proposition | Ⅱ-1.2, Ⅴ, Ⅶ |
| 6 | [챕터 09 공식본 (v1.0)](https://github.com/ahalenin12-art/business_research/blob/main/09-value-proposition/value-proposition-03-art-redistribution-platform-v1.0.md) | 공식 커리큘럼 챕터 09 산출물 | 이 문서와는 별개로 유지되는 공식 형식 |
