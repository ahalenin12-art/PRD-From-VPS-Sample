...
- **최종 업데이트:** 2026-08-14
- **기반 문서:** [VPS Rooted · Final](../04_VPS-final/06_value-proposition-sheet_260814(fin).md) (공식 챕터 09가 아니라 [`00_Prompt-History`-`04_VPS-final` 실습 트랙](../04_VPS-final/06_value-proposition-sheet_260814(fin).md#0-이-문서의-범위--두-개의-서로-다른-구조가-이-저장소에-공존한다)의 산출물)
